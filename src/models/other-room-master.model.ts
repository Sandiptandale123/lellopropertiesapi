...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'other_room_master'}
  }
})
export class OtherRoomMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'otherRoomId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  otherRoomId?: number;
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'otherRoomName', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  ...
  constructor(data?: Partial<OtherRoomMaster>) {
    super(data);
  }
}

export interface OtherRoomMasterRelations {
  // describe navigational properties here
}

export type OtherRoomMasterWithRelations = OtherRoomMaster & OtherRoomMasterRelations;
