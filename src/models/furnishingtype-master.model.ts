...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'furnishingtype_master'}
  }
})
export class FurnishingtypeMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'furnishingtypeId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'furnishingtype', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  ...
  constructor(data?: Partial<FurnishingtypeMaster>) {
    super(data);
  }
}

export interface FurnishingtypeMasterRelations {
  // describe navigational properties here
}

export type FurnishingtypeMasterWithRelations = FurnishingtypeMaster & FurnishingtypeMasterRelations;
