...
@model({
  settings: {idInjection: false, mysql: {schema: 'lellopropertydb', table: 'title_master'}}
})
export class TitleMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'titleId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  titleId?: number;
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'titleName', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  titleName?: string;
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'subTitleName', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  subTitleName?: string;
  ...
  constructor(data?: Partial<TitleMaster>) {
    super(data);
  }
}

export interface TitleMasterRelations {
  // describe navigational properties here
}

export type TitleMasterWithRelations = TitleMaster & TitleMasterRelations;
