...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'available_status_master'}
  }
})
export class AvailableStatusMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'availablestatusId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'fkreadytomoveId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: false},
  })
  fkreadytomoveId: number;
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'fkunderconstructionId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: false},
  })
  fkunderconstructionId: number;
  ...
  constructor(data?: Partial<AvailableStatusMaster>) {
    super(data);
  }
}

export interface AvailableStatusMasterRelations {
  // describe navigational properties here
}

export type AvailableStatusMasterWithRelations = AvailableStatusMaster & AvailableStatusMasterRelations;
