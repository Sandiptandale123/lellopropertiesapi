...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'property_type_master'}
  }
})
export class PropertyTypeMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'propertyTypeId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'propertytypeName', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  ...
  constructor(data?: Partial<PropertyTypeMaster>) {
    super(data);
  }
}

export interface PropertyTypeMasterRelations {
  // describe navigational properties here
}

export type PropertyTypeMasterWithRelations = PropertyTypeMaster & PropertyTypeMasterRelations;
