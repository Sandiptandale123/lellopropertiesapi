...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'bestproperty_launch'}
  }
})
export class BestpropertyLaunch extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'bestlaunchId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  bestlaunchId?: number;
  ...
  constructor(data?: Partial<BestpropertyLaunch>) {
    super(data);
  }
}

export interface BestpropertyLaunchRelations {
  // describe navigational properties here
}

export type BestpropertyLaunchWithRelations = BestpropertyLaunch & BestpropertyLaunchRelations;
