...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'background_image_master'}
  }
})
export class BackgroundImageMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'backImgId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  backImgId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'backImage', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  backImage?: string;
  ...
  constructor(data?: Partial<BackgroundImageMaster>) {
    super(data);
  }
}

export interface BackgroundImageMasterRelations {
  // describe navigational properties here
}

export type BackgroundImageMasterWithRelations = BackgroundImageMaster & BackgroundImageMasterRelations;
