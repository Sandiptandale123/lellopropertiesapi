...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'publish_type_master'}
  }
})
export class PublishTypeMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'publish_typeId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'publish_typeName', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  ...
  constructor(data?: Partial<PublishTypeMaster>) {
    super(data);
  }
}

export interface PublishTypeMasterRelations {
  // describe navigational properties here
}

export type PublishTypeMasterWithRelations = PublishTypeMaster & PublishTypeMasterRelations;
