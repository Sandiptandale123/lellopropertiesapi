...
@model({
  settings: {idInjection: false, mysql: {schema: 'lellopropertydb', table: 'floor_master'}}
})
export class FloorMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'floorId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  floorId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'floorImg', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  floorImg: string;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'floorType', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  floorType: string;
  ...
  constructor(data?: Partial<FloorMaster>) {
    super(data);
  }
}

export interface FloorMasterRelations {
  // describe navigational properties here
}

export type FloorMasterWithRelations = FloorMaster & FloorMasterRelations;
