...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'furnishing_master'}
  }
})
export class FurnishingMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'furnishingId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  furnishingId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'furnishingName', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  ...
  constructor(data?: Partial<FurnishingMaster>) {
    super(data);
  }
}

export interface FurnishingMasterRelations {
  // describe navigational properties here
}

export type FurnishingMasterWithRelations = FurnishingMaster & FurnishingMasterRelations;
