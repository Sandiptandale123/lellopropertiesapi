...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'best_property_master'}
  }
})
export class BestPropertyMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'bestPropertyId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'bestPropTitle', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  bestPropTitle?: string;
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'bestPropSubtitle', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  bestPropSubtitle?: string;
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'fkPostPropertyId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'Y', generated: false},
  })
  ...
  constructor(data?: Partial<BestPropertyMaster>) {
    super(data);
  }
}

export interface BestPropertyMasterRelations {
  // describe navigational properties here
}

export type BestPropertyMasterWithRelations = BestPropertyMaster & BestPropertyMasterRelations;
