...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'our_partner_master'}
  }
})
export class OurPartnerMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'partnerId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  partnerId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'partnerName', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  partnerName?: string;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'partnerLogo', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  partnerLogo?: string;
  ...
  constructor(data?: Partial<OurPartnerMaster>) {
    super(data);
  }
}

export interface OurPartnerMasterRelations {
  // describe navigational properties here
}

export type OurPartnerMasterWithRelations = OurPartnerMaster & OurPartnerMasterRelations;
