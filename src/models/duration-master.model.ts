...
@model({
  settings: {idInjection: false, mysql: {schema: 'lellopropertydb', table: 'duration_master'}}
})
export class DurationMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'durationId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  durationId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'durationName', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  durationName: string;
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'durationValue', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: false},
  })
  ...
  constructor(data?: Partial<DurationMaster>) {
    super(data);
  }
}

export interface DurationMasterRelations {
  // describe navigational properties here
}

export type DurationMasterWithRelations = DurationMaster & DurationMasterRelations;
