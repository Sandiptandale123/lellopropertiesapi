...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'ready_to_move_master'}
  }
})
export class ReadyToMoveMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'readytomoveId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  readytomoveId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'title', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  title: string;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'rteadytomoveperiod', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  rteadytomoveperiod: string;
  ...
  constructor(data?: Partial<ReadyToMoveMaster>) {
    super(data);
  }
}

export interface ReadyToMoveMasterRelations {
  // describe navigational properties here
}

export type ReadyToMoveMasterWithRelations = ReadyToMoveMaster & ReadyToMoveMasterRelations;
