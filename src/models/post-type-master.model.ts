...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'post_type_master'}
  }
})
export class PostTypeMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'postTypeId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  postTypeId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'posttypeName', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  posttypeName: string;
  ...
  constructor(data?: Partial<PostTypeMaster>) {
    super(data);
  }
}

export interface PostTypeMasterRelations {
  // describe navigational properties here
}

export type PostTypeMasterWithRelations = PostTypeMaster & PostTypeMasterRelations;
