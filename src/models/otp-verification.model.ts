...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'otp_verification'}
  }
})
export class OtpVerification extends Entity {
  @property({
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'otp_Id', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  otpId?: number;
  ...
  @property({
    ...
    length: 15,
    generated: false,
    mysql: {columnName: 'mobile_number', dataType: 'varchar', dataLength: 15, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  mobileNumber: string;
  ...
  @property({
    ...
    length: 6,
    generated: false,
    mysql: {columnName: 'otp_code', dataType: 'varchar', dataLength: 6, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  otpCode: string;
  ...
  @property({
    ...
    jsonSchema: {nullable: false},
    generated: false,
    mysql: {columnName: 'expires_at', dataType: 'datetime', dataLength: null, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  expiresAt: string;
...
export interface OtpVerificationRelations {
  // describe navigational properties here
}

export type OtpVerificationWithRelations = OtpVerification & OtpVerificationRelations;
