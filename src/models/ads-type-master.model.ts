...
@model({
  settings: {idInjection: false, mysql: {schema: 'lellopropertydb', table: 'ads_type_master'}}
})
export class AdsTypeMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'adsTypeId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  adsTypeId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'adstypeName', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  adstypeName: string;
  ...
  constructor(data?: Partial<AdsTypeMaster>) {
    super(data);
  }
}

export interface AdsTypeMasterRelations {
  // describe navigational properties here
}

export type AdsTypeMasterWithRelations = AdsTypeMaster & AdsTypeMasterRelations;
