...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'main_propertty_type_master'}
  }
})
export class MainProperttyTypeMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'mainpropertytypeId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  mainpropertytypeId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'mainprpoertyName', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  mainprpoertyName: string;
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'fkposttypeId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: false},
  })
  fkposttypeId: number;
  ...
  constructor(data?: Partial<MainProperttyTypeMaster>) {
    super(data);
  }
}

export interface MainProperttyTypeMasterRelations {
  // describe navigational properties here
}

export type MainProperttyTypeMasterWithRelations = MainProperttyTypeMaster & MainProperttyTypeMasterRelations;
