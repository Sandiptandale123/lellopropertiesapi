...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'area_measurement_master'}
  }
})
export class AreaMeasurementMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'areaMeasurementId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'areaMeasurementName', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  areaMeasurementName?: string;
  ...
  constructor(data?: Partial<AreaMeasurementMaster>) {
    super(data);
  }
}

export interface AreaMeasurementMasterRelations {
  // describe navigational properties here
}

export type AreaMeasurementMasterWithRelations = AreaMeasurementMaster & AreaMeasurementMasterRelations;
