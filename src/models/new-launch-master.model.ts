...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'new_launch_master'}
  }
})
export class NewLaunchMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'newLaunchId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  newLaunchId?: number;
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'newLaunchTitle', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'newLaunchSubtitle', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  ...
  constructor(data?: Partial<NewLaunchMaster>) {
    super(data);
  }
}

export interface NewLaunchMasterRelations {
  // describe navigational properties here
}

export type NewLaunchMasterWithRelations = NewLaunchMaster & NewLaunchMasterRelations;
