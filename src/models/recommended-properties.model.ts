...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'recommended_properties'}
  }
})
export class RecommendedProperties extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'recommendPropId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  recommendPropId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'subTitle', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  subTitle?: string;
  ...
  constructor(data?: Partial<RecommendedProperties>) {
    super(data);
  }
}

export interface RecommendedPropertiesRelations {
  // describe navigational properties here
}

export type RecommendedPropertiesWithRelations = RecommendedProperties & RecommendedPropertiesRelations;
