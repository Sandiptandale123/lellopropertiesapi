...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'maintenance_month_master'}
  }
})
export class MaintenanceMonthMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'maintenanacemonthId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  maintenanacemonthId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'maintenanceName', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  ...
  constructor(data?: Partial<MaintenanceMonthMaster>) {
    super(data);
  }
}

export interface MaintenanceMonthMasterRelations {
  // describe navigational properties here
}

export type MaintenanceMonthMasterWithRelations = MaintenanceMonthMaster & MaintenanceMonthMasterRelations;
