...
@model({
  settings: {idInjection: false, mysql: {schema: 'lellopropertydb', table: 'usertype'}}
})
export class Usertype extends Entity {
  @property({
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'userId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  userId?: number;
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'username', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  username?: string;
