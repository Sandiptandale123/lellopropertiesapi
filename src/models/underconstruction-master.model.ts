...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'underconstruction_master'}
  }
})
export class UnderconstructionMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'underconstuctionId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  underconstuctionId?: number;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'underconstructionTitle', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'underconstructionPeriod', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'N', generated: false},
  })
  underconstructionPeriod: string;
  ...
  constructor(data?: Partial<UnderconstructionMaster>) {
    super(data);
  }
}

export interface UnderconstructionMasterRelations {
  // describe navigational properties here
}

export type UnderconstructionMasterWithRelations = UnderconstructionMaster & UnderconstructionMasterRelations;
