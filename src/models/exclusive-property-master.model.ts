...
@model({
  settings: {
    idInjection: false,
    mysql: {schema: 'lellopropertydb', table: 'exclusive_property_master'}
  }
})
export class ExclusivePropertyMaster extends Entity {
  @property({
    type: 'number',
    ...
    generated: 1,
    id: 1,
    mysql: {columnName: 'exclusivePropertyId', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N', generated: 1},
  })
  exclusivePropertyId?: number;
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'exclusivePropertyTitle', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  exclusivePropertyTitle?: string;
  ...
  @property({
    ...
    length: 100,
    generated: false,
    mysql: {columnName: 'exclusivePropertySubtitle', dataType: 'varchar', dataLength: 100, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  exclusivePropertySubtitle?: string;
  ...
  @property({
    ...
    length: 255,
    generated: false,
    mysql: {columnName: 'exclusivePropertyImg', dataType: 'varchar', dataLength: 255, dataPrecision: null, dataScale: null, nullable: 'Y', generated: false},
  })
  exclusivePropertyImg?: string;
  ...
  constructor(data?: Partial<ExclusivePropertyMaster>) {
    super(data);
  }
}

export interface ExclusivePropertyMasterRelations {
  // describe navigational properties here
}

export type ExclusivePropertyMasterWithRelations = ExclusivePropertyMaster & ExclusivePropertyMasterRelations;
